...
import yangfentuozi.dsusideloaderplus.model.DSUConstants
...
class Preparation(
    ...
    private fun prepareForDSU() {
        ...
        val preparedFilePair =
            when (fileExtension) {
                ...
                "7z" -> prepare7z(userSelectedFileUri)
        ...
        val source = if (fileExtension == "zip" || fileExtension == "7z") {
    ...
    private fun prepare7z(sevenZFile: Uri): Pair<Uri, Long> {
        ...
        return Pair(zipFilePair.first, -1)
    }
}
