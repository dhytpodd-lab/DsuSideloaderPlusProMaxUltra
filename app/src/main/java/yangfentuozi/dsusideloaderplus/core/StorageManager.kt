package yangfentuozi.dsusideloaderplus.core
...
import yangfentuozi.dsusideloaderplus.util.DataStoreUtils
...
class StorageManager(
    ...
    fun openFileDescriptor(uri: Uri, mode: String): android.os.ParcelFileDescriptor {
        return appContext.contentResolver.openFileDescriptor(uri, mode)!!
    }
